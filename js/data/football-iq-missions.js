export const FOOTBALL_IQ_MISSIONS = Object.freeze([
  ...
  },
  {
    ...
    xp:15,
    minutes:5,
    description:"Read the developing pattern and identify the most likely next action before it happens.",
    objectives:["Recognise the strongest pattern cue","Connect player movement with the likely next pass","Make a prediction before the action is obvious"],
    coachingPrompt:"See what the picture is becoming.",
    successIndicators:["Recognises the key developing cue","Predicts the likely next action","Responds before the pass or movement is completed","Repeats accurate predictions across scenarios"],
    assessmentCriteria:{ recognition:"Identifies the cue that best predicts the next action", timing:"Makes the prediction before the next action begins", decisionQuality:"Selects the most likely high-value continuation" },
    commonMistakes:["Waiting until the action has started","Following only the ball","Guessing without using player movement or shape"],
    feedback:{ before:"Read the movement and shape. What happens next?", during:["Read the pattern","Predict early","Use the strongest clue"], after:{ strength:"You recognised where the play was developing.", improvement:"Commit to the prediction before the next action begins.", transferQuestion:"In your next match, what player movement could tell you where the next pass is going?" } },
    status:"available",
    recommended:true,
    launchRoute:"training",
    runtimeMode:"generic_fallback",
  ...
  {
    id:"see-weak-side",
    title:"See the Weak Side",
    category:"vision",
    progressionStage:"developing",
    difficulty:3,
    xp:20,
    minutes:5,
    description:"Recognise valuable space and options on the side away from the immediate ball action.",
    objectives:["Check the side away from the ball","Identify when the defence has become overloaded or narrow","Recognise the best route to access weak-side space"],
    coachingPrompt:"Look where the defence is not looking.",
    successIndicators:["Identifies useful weak-side space","Recognises when the near side is crowded","Connects the current action to a switch or diagonal option","Selects the weak-side option before it closes"],
    assessmentCriteria:{ recognition:"Identifies the valuable option away from the ball", timing:"Checks the weak side before the near-side action is trapped", decisionQuality:"Selects an appropriate route to access the weak side" },
    commonMistakes:["Watching only the crowded side","Seeing open space without identifying how to reach it","Switching automatically when a better central option remains"],
    feedback:{ before:"The ball attracts players. Check the space it leaves behind.", during:["Check the far side","See the space away from pressure","Find the route across"], after:{ strength:"You recognised value away from the immediate action.", improvement:"Check the far side earlier, before the defence can recover.", transferQuestion:"When play becomes crowded on one side, where is the weak-side teammate or space in your next match?" } },
    status:"available",
    recommended:false,
    launchRoute:"training",
    runtimeMode:"generic_fallback",
  ...
  },
  {
    ...
    xp:25,
    minutes:6,
    description:"Recognise where your team has a numerical or positional advantage as pressure and movement change.",
    objectives:["Compare player numbers and positioning across zones","Identify the overload that can progress play","Update the preferred overload when defenders shift"],
    coachingPrompt:"Find where your team has the advantage.",
    successIndicators:["Recognises a numerical or positional overload","Distinguishes a useful overload from harmless possession","Updates the best option when defenders move","Acts accurately within a shorter decision window"],
    assessmentCriteria:{ recognition:"Identifies the zone containing the meaningful advantage", timing:"Recognises the overload before defenders rebalance", decisionQuality:"Selects the action that uses the advantage most effectively" },
    commonMistakes:["Counting players without considering position","Choosing the nearest overload rather than the useful one","Keeping the original option after defenders shift"],
    feedback:{ before:"Compare the zones. Where does your team have the real advantage?", during:["Find the extra player","Check whether the advantage can progress play","Update when defenders move"], after:{ strength:"You identified where your team could create an advantage.", improvement:"Judge the quality of the overload, not only the player count.", transferQuestion:"In your next match, can you recognise when your team has an extra player or better position in one zone?" } },
    status:"available",
    recommended:false,
    launchRoute:"training",
    runtimeMode:"generic_fallback",
