...
function handleCanonicalClick(event){
  ...
  if(!next && !back && !avatarChoice) return;
...
window.PitchIQAcademy = Object.freeze({ render, advance, enter: () => { stage="welcome"; window.location.hash=CANONICAL_ROUTE; queueMicrotask(render); } });
