import { applyHomeWorldStack } from "./home-world-stack-h5.js?v=sprint-h28b-world-carousel-preview-20260722";
...
function ensureStylesheet() {
  ...
  appendStylesheet(FOUR_WORLDS_STYLE_ID, "css/home-four-worlds-h16.css?v=sprint-h28b-world-carousel-preview-20260722");
...
function applyHomeInformationArchitecture(home, stack) {
  ...
  if (rewards) {
    ...
    const worldTail = worldsPreview || worlds;
    if (supporting) {
      supporting.classList.add("home-rewards-row");
      supporting.dataset.homeSlot = "academy-rewards";
      supporting.replaceChildren(rewards);
      worldTail ? worldTail.after(supporting) : stack.append(supporting);
    } else {
      worldTail ? worldTail.after(rewards) : stack.append(rewards);
    }
  }

  home.dataset.homeComposition = "h28b-world-carousel-preview";
}
