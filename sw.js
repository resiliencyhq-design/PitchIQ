const CACHE="pitchiq-onboarding-refresh-861bbe20";
const ASSETS=[
  "./",
  "./index.html",
  "./css/style.css?v=861bbe4",
  "./css/splash-fit.css?v=861bbe16",
  "./css/onboarding-fix.css?v=861bbe20",
  ...
  "./assets/controls/continue-button.png?v=861bbe20",
  "./assets/controls/enter-academy.png?v=861bbe20",
