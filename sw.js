const CACHE="pitchiq-step1-full-number-20260620";
const ASSETS=[
  "./",
  "./index.html",
  ...
  "./js/app/routes.js?v=step1-person-crop-20260620",
  ...
  "./assets/onboarding/name-person-icon.png?v=step1-person-crop-20260620",
