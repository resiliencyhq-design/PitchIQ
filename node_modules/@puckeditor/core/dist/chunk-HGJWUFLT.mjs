import {
  useAlignOptions
} from "./chunk-DPDJ67KA.mjs";
import {
  useHeadingOptions
} from "./chunk-ZMTK7SMX.mjs";
import {
  useListOptions
} from "./chunk-LODTL5KW.mjs";
import {
  AlignCenter,
  AlignJustify,
  AlignLeft,
...
init_react_import();
var IconButton_module_default = { "IconButton": "_IconButton_1c68y_1", "IconButton--active": "_IconButton--active_1c68y_14", "IconButton--disabled": "_IconButton--disabled_1c68y_24" };
...
var AlignSelectLoaded = lazy(
  () => import("./loaded-54625GTL.mjs").then((m) => ({
...
var HeadingSelectLoaded = lazy2(
  () => import("./loaded-OMRIYZIQ.mjs").then((m) => ({
...
var ListSelectLoaded = lazy3(
  () => import("./loaded-Y4ZWZC55.mjs").then((m) => ({
